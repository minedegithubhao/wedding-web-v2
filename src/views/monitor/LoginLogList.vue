<template>
  <a-card :bordered="false">
          ...
          <a-col :md="4"
            ...
            <a-form-item label="登陆状态">
              <a-select placeholder="请选择"
                ...
                <a-select-option v-for="(d, index) in commonStatus"
                                 :key="index"
    ...
    <s-table size="default"
      ...
      <span slot="status"
            slot-scope="text"><a-badge :status="text | statusTypeFilter"
                 :text="text | statusFilter" /></span>
    </s-table>
  </a-card>
</template>
...
import { cleanLoginLog, delLoginLog, getLoginLogList } from '@/api/monitor'
