  ...
  <a-card :bordered="false">
          ...
          <a-col :md="8"
            ...
            <span class="table-page-search-submitButtons">
              ...
              <a-button style="margin-left: 8px"
                        @click="() => queryParam = {delFlag: false}">重置</a-button>
            </span>
          </a-col>
        </a-row>
      </a-form>
    ...
    <s-table size="default"
      ...
      <span slot="action"
        ...
        <a-divider v-if="!record.delFlag"
                   type="vertical" />
        <a v-if="!record.delFlag"
           @click="delByIds([record.auditId])">删除</a>
      </span>
    </s-table>
