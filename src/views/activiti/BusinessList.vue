  ...
  <a-card :bordered="false">
          ...
          <a-col :md="5"
            ...
            <a-form-item label="状态">
              <a-select placeholder="请选择"
                ...
                <a-select-option v-for="(val, key) in statusMap"
                                 :key="key"
                                 :value="key">{{ val }}</a-select-option>
              </a-select>
            </a-form-item>
          </a-col>
          <a-col :md="5"
            ...
            <a-form-item label="审批结果">
              <a-select placeholder="请选择"
                        ...
                        default-value="0">
                <a-select-option :value="''">全部</a-select-option>
                <a-select-option v-for="(val, key) in resultMap"
                                 :key="key"
                                 :value="key">{{ val }}</a-select-option>
              </a-select>
            </a-form-item>
    ...
    <s-table size="default"
      ...
      <span slot="action"
        ...
        <a :disabled="record.status!==1"
           @click="cancel([record.procInstId])">撤销</a>
        <a-divider type="vertical" />
        <a :disabled="record.status===1"
