<template>
  <a-card :bordered="false">
    ...
    <s-table size="default"
      ...
      <span slot="resourceName"
            slot-scope="text, record">
        <a @click="handleModelXml(record)">{{ text }}</a>
      </span>
      <span slot="dgrmResourceName"
            slot-scope="text, record">
      ...
      <span slot="action"
        ...
        <a-divider v-if="editEnabel"
                   type="vertical" />
        <a v-if="editEnabel"
           @click="handleNode(record.id)">节点配置</a>
        <a-divider v-if="removeEnable"
                   type="vertical" />
        <a v-if="removeEnable"
           @click="delByIds([record.deploymentId])">删除</a>
      </span>
    </s-table>
