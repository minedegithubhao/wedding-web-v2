  ...
  <a-modal title="操作"
    ...
    <a-form :form="form">
      <a-row :gutter="64">
        ...
        <a-col :span="12">
          <div class="modal-divider-text">高级配置</div>
          <a-form-item :labelCol="labelCol"
                       :wrapperCol="wrapperCol"
                       label="部门">
            <a-tree-select v-decorator="['deptId', {rules: [{ required: true, message: '请选择部门' }]}]"
          ...
          <a-form-item :labelCol="labelCol"
            ...
            <a-select style="width: 100%"
                      ...
                      :allowClear="true">
              <a-select-option v-for="(action) in roleAll"
                               :key="action.roleId">{{ action.roleName }}</a-select-option>
            </a-select>
          </a-form-item>
        </a-col>
      </a-row>
