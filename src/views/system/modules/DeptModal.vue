  ...
  <a-modal title="操作"
    ...
    <a-form :form="form">
      ...
      <a-form-item :labelCol="labelCol"
                   ...
                   label="上级部门">
        <a-tree-select v-decorator="['parentId', {initialValue:'0',rules: [{ required: true, message: '请选择上级部门' }]}]"
      ...
      <a-form-item :labelCol="labelCol"
                   :wrapperCol="wrapperCol"
                   label="显示顺序">
        <a-input v-decorator="['orderNum',{rules: [{ required: true, message: '请输入显示顺序' }]}]"
                 placeholder="显示顺序" />
      </a-form-item>
      <a-form-item :labelCol="labelCol"
                   :wrapperCol="wrapperCol"
                   label="负责人">
        <a-input v-decorator="['leader',{rules: [{ required: true, message: '请输入负责人' }]}]"
                 placeholder="负责人" />
      </a-form-item>
      <a-form-item :labelCol="labelCol"
                   :wrapperCol="wrapperCol"
    ...
    edit (record) {
      ...
      this.$nextTick(() => {
        ...
        this.form.setFieldsValue(
          pick(this.mdl, 'deptId', 'parentId', 'leader', 'phone', 'status', 'email', 'orderNum', 'deptName')
        )
