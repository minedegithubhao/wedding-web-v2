<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button v-if="configEnabel"
                type="primary"
                icon="setting"
                @click="$refs.modal.config()">云存储配置</a-button>
    ...
    <s-table size="default"
      ...
      <template v-for="col in ['fileName']"
                :slot="col"
      ...
      <img style="width:30px;heigth:30px;cursor:pointer;"
           slot="url"
           slot-scope="text"
           :src="text"
