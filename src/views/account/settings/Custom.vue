<template>
  ...
  <a-list itemLayout="horizontal">
    ...
    <a-list-item>
      ...
      <div slot="actions">
        <a-switch checkedChildren="反转" unCheckedChildren="正常" :defaultChecked="colorWeak" @change="colorWeakChange" />
      </div>
    </a-list-item>
    <a-list-item>
      <a-list-item-meta>
...
<script>
import { updateTheme, colorList, updateColorWeak } from '@/components/SettingDrawer/settingConfig'
