    ...
    renderSwitcher: function renderSwitcher() {
      ...
      if (this.isLeaf2()) {
        return h(
          ...
          [typeof switcherIcon === 'function' ? switcherIcon(_extends({}, this.$props, { isLeaf: true })) : switcherIcon]
        );
      }
      ...
      return h(
        ...
        { key: 'switcher', on: {
          ...
          'class': switcherCls },
        [typeof switcherIcon === 'function' ? switcherIcon(_extends({}, this.$props, { isLeaf: false })) : switcherIcon]
      );
    },
